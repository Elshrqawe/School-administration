                    ...
                    <br><br>
                        ...
                        <form action="{{ route('Filter_Classes') }}" method="POST">
                            ...
                            <select class="selectpicker" data-style="btn-info" name="Grade_id" required
                                   onchange="this.form.submit()">{{-- نفذ الفورم عند الاختيار --}}
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('Classrooms.destroy', 'test') }}"
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary"
                                                                data-dismiss="modal">{{ trans('My_Classes_trans.not sure') }}</button>
                                                        <button type="submit"
                                                                class="btn btn-danger">{{ trans('My_Classes_trans.yes sure') }}</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>

        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-row">
                    ...
                    <div class="col">
                        <label for="title" style="color: #00ff0f">{{trans('Parent_trans.Passport_ID_Father')}}</label>
                ...
                <button class="btn btn-danger btn-sm nextBtn btn-lg pull-right" type="button" wire:click="hiddnformadd">
                    {{trans('Parent_trans.Close')}}
                </button>

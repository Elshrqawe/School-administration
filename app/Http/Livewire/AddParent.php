...
class AddParent extends Component
{
    ...
    public function firstStepSubmit()
    {
        $this->validate([
            ...
            'Passport_ID_Father' => 'unique:my__parents,Passport_ID_Father,' . $this->id,
    ...
    public function secondStepSubmit()
    {
        ...
        $this->validate([
            ...
            'Passport_ID_Mother' => 'unique:my__parents,Passport_ID_Mother,' . $this->id,
